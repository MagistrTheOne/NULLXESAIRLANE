    ...
    <div className="pointer-events-auto">
      ...
      >
        <span className="relative flex h-6 w-6 items-center justify-center rounded-full bg-zinc-950/60 ring-1 ring-zinc-500/60">
          <span className="absolute inset-1 rounded-full bg-linear-to-br from-emerald-400/70 to-sky-400/40 opacity-80" />
          <span className="relative inline-flex h-1.5 w-1.5 rounded-full bg-emerald-200 shadow-[0_0_14px_rgba(52,211,153,0.9)]" />
        </span>
